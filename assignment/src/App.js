...
const App = (props) => {
  ...
  const renderPieChart = () => {
    if (userData && userData.user.top_products) {
      const { top_products } = userData.user;
      const data = top_products.map((product) => ({
  ...
  const renderLineChart = () => {
    if (userData && userData.user.website_stats) {
      const { total_users_weekly, total_guests_weekly } =
        userData.user.website_stats;
      const data = Object.keys(total_users_weekly).map((week) => ({
        week: `Week ${week}`,
        users: total_users_weekly[week],
        guests: total_guests_weekly[week],
      }));
      ...
      return (
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis
              dataKey="week"
              ticks={data.map((entry) => entry.week)}
              axisLine={false}
              padding={{ right: 30 }}
              tick={{ dy: 10 }}
            />
  ...
  return (
    <div>
      {profile ? (
        <div
          id="mainPage"
          className="w-full min-h-screen min-w-screen bg-neutral-100 h-full flex justify-around py-10 font-montserrat"
        >
          <div
            id="sideBoard"
            className="font-montserrat hidden w-[280px] justify-between flex-col lg:flex py-[60px] px-[50px] h-screen bg-black rounded-[30px]"
          >
            <div>
              <div className="text-white text-4xl font-bold">Board.</div>
              <button className="text-white text-lg font-bold mt-[60px] flex gap-5 items-center mb-[40px]">
                {" "}
                <svg
                  width="18"
                  height="18"
              ...
              <button className="text-white text-lg font-normal flex gap-5 items-center mb-[40px]">
                <svg
                  width="18"
                  height="21"
                  viewBox="0 0 18 21"
            ...
            <div>
              <button className=" text-white text-sm font-normal">Help</button>
          ...
          <div className="w-full px-5 lg:px-0 lg:w-[70%] h-[86%] flex flex-col py-[20px]">
            <div className="flex justify-between w-full ">
              ...
              <div className="flex gap-[30px] items-center">
                <input
                  className="w-[180px] px-[15px] placeholder:text-zinc-400 hidden lg:flex text-sm h-[30px] rounded-[10px]"
                  placeholder="Search"
                />
                <svg
                  width="18"
                ...
                <button onClick={logOut} className="w-[30px] h-[30px]">
                  <img
                    src={profile.picture}
            ...
            {userData ? (
              <div className="w-full">
                <div
                  id="firstRow"
                  className="flex flex-wrap my-10 justify-around lg:justify-between w-full gap-10"
                >
                  <div className="lg:w-[220px] w-[150px] h-[120px] rounded-[20px] bg-[#DDEFE0]  px-[25px] py-[20px]">
                  ...
                  <div className="lg:w-[220px] w-[150px] h-[120px] rounded-[20px] bg-orange-100 px-[25px] py-[20px]">
                    <div className="w-full flex justify-end">
                      <svg
                        width="21"
                        height="24"
                  ...
                  <div className="lg:w-[220px] w-[150px] h-[120px] rounded-[20px] bg-[#EFDADA] px-[25px] py-[20px]">
                    <div className="w-full flex justify-end">
                      <svg
                        width="24"
                        height="24"
                  ...
                  <div className="lg:w-[220px] w-[150px] h-[120px] rounded-[20px] bg-[#DEDFEF] px-[25px] py-[20px]">
                    <div className="w-full flex justify-end">
                      <svg
                        width="37"
                        height="24"
                ...
                <div
                  id="activities"
                  className="lg:h-[360px] lg:w-full bg-white rounded-[20px] px-10 py-[30px] flex flex-col"
                >
                  <div className="w-full flex justify-between text-black lg:text-lg font-bold">
                    ...
                    <div className="flex gap-9 font-lato">
                      ...
                      <div className="flex items-center text-sm font-normal gap-3">
                        <div className="bg-[#9BDD7C] w-[10px] h-[10px] rounded-full"></div>
                        <p>User</p>
                      </div>
                    </div>
                  </div>
                  <div className="w-auto h-auto flex items-center gap-[5px] text-zinc-500 text-sm font-normal">
                    May - June 2021
                    <svg
                      width="8"
                      height="5"
                ...
                >
                  <div className="bg-white h-[256px] w-full md:w-[48%] lg:[48%] mt-10 rounded-[20px] px-10 py-[30px]">
                    ...
                    <div
                      ...
                      className="flex w-full mt-[30px] px-[10px] gap-[50px] "
                    >
                      {renderPieChart()}
                      <div className="">
                        <div className=" text-sm flex flex-col lg:mb-5 mb-2 justify-start">
                          <p className="text-black text-sm font-bold flex items-center gap-[10px]">
                            <div className="bg-[#9BDD7C] w-[10px] h-[10px] rounded-full"></div>
                            {userData.user.top_products[0].product_name}
                          </p>
                          <p className="ml-[20px] text-zinc-500 text-xs font-normal">
                            {userData.user.top_products[0].percentage_sale}%
                          </p>
                        </div>
                        <div className=" text-sm flex lg:mb-5 mb-2 flex-col justify-start">
                          <p className="text-black text-sm font-bold flex items-center gap-[10px]">
                            <div className="bg-[#F6DC7D] w-[10px] h-[10px] rounded-full"></div>
                            {userData.user.top_products[1].product_name}
                          </p>
                          <p className="ml-[20px] text-zinc-500 text-xs font-normal">
                            {userData.user.top_products[1].percentage_sale}%
                          </p>
                        </div>
                        <div className=" text-sm flex flex-col justify-start">
                          <p className="text-black text-sm font-bold flex items-center gap-[10px]">
                            <div className="bg-[#EE8484] w-[10px] h-[10px] rounded-full"></div>
                            {userData.user.top_products[2].product_name}
                          </p>
                          <p className="ml-[20px] text-zinc-500 text-xs font-normal">
                            {userData.user.top_products[2].percentage_sale}%
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-white h-[256px] w-full md:w-[48%] lg:[48%] mt-10 rounded-[20px] px-10 py-[30px]">
                    ...
                    <div className="flex mt-[25px]">
                      ...
                      <div className="ml-[10px] flex flex-col justify-center gap-[5px]">
                        <p className="text-stone-500 text-sm font-bold">
                          {userData.user.user_schedule[0].title}
                        </p>
                        <p className="text-neutral-400 text-xs font-normal">
                          {userData.user.user_schedule[0].time_range}
                        </p>
                        <p className="text-neutral-400 text-xs font-normal">
                          {userData.user.user_schedule[0].location}
                        </p>
                      </div>
                    </div>
        ...
        <div id="signInDiv" className="flex h-screen w-screen">
          <div className="h-full hidden  w-[40%] bg-black lg:flex md:flex justify-center items-center">
          ...
          <div
            id="SignIn"
            className="lg:w-[60%] w-full h-full flex items-center justify-center flex-col bg-neutral-100"
          >
            <div>
              <h1 className="font-montserrat text-black text-4xl font-bold text-start mb-[5px]">
                Sign In
              </h1>
              <h1 className="font-lato mb-[26px] text-black text-base font-normal">
                Sign in to your account
              </h1>
              <div className="flex font-montserrat mb-[25px] gap-[25px]">
                <button
                  onClick={() => login()}
                  className="w-[180px] h-[30px] flex items-center justify-center gap-[10.5px] bg-white rounded-[10px]"
                >
                  <svg
                    width="14"
                    height="14"
